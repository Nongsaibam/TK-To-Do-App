  ...
  return (
    <div className="w-full max-w-[420px]">
      <div className="mb-8">
        ...
        <h2 className="mt-2 text-3xl font-semibold text-[#111827]">Sign in</h2>
        <p className="mt-2 text-sm leading-6 text-[#6b7280]">Enter your details to access your workspace.</p>
      </div>
      ...
      <p className="mt-6 text-sm text-[#6b7280]">
        New here?{' '}
        <Link className="font-semibold text-[#111827] underline underline-offset-4" to={routePaths.register}>
          Create an account
        </Link>
      </p>
    </div>
